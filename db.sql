-- MySQL dump 10.13  Distrib 5.6.51, for osx10.15 (x86_64)
--
-- Host: localhost    Database: wechatShop
-- ------------------------------------------------------
...
INSERT INTO `tb_area` VALUES (1,'Williston',1,NULL,NULL);
...
CREATE TABLE `tb_person_info` (
  ...
  `user_type` int(2) NOT NULL DEFAULT '1' COMMENT '1 customer 2 shop owner 3 super admin',
  `create_time` datetime DEFAULT NULL,
  `last_edit_time` datetime DEFAULT NULL,
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Dump completed on 2021-02-17  0:03:33
